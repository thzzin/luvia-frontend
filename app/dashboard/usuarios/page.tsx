...
function ContatoPage() {
    ...
    <div>
        ...
        <div className="flex flex-col md:flex-row justify-start mb-6 mt-8 space-y-4 md:space-y-0 md:space-x-4">
            {/* Campo de pesquisa */}
            <div className="relative max-w-[50vw] md:max-w-[20vw]">
                <Input
            ...
            {/* Botões de Ação: Alinhados lado a lado embaixo do input no mobile */}
        <div className="flex flex-col md:flex-row justify-start mb-6 mt-8 space-y-4 md:space-y-0 md:space-x-4">
                <AddContact addContato={toastUsuarios} onContactAdded={handleContactAdded} />
                <Button onClick={exportToCSV} className='max-w-[50vw]'>
        ...
        <Card className="w-full max-w-[87vw] pb-8 mb-16 md:max-w-[60vw] mt-4 ml-0">
            <CardContent>
                <div className="overflow-x-auto">
                    <Table className="mt-2 min-w-[700px]">
                        <TableHeader>
                            <TableRow>
                                <TableHead>#</TableHead>
            ...
            <CardFooter className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
                <Pagination     >
                    <PaginationContent>
                        <PaginationItem>
                            <PaginationPrevious
                ...
                <div className='w-[50vw] md:max-w-[30vw]'>
                ...
                <span className="pl-0 md:pl-6">{totalFiltered} {totalFiltered === 1 ? 'contato' : 'contatos'} encontrados</span>
            </CardFooter>
        </Card>
    </div>
);
