...
export default function Component() {
  ...
  <div className="h-screen w-full flex items-center justify-center bg-[#030712]">
    <div className="p-8 sm:p-14 w-full max-w-sm sm:max-w-md bg-[#0f131e] rounded-lg shadow-lg border border-transparent">
      <form onSubmit={handleSubmit} className="flex flex-col items-center">
        <Image
          ...
          width={130}
          height={130}
          className="mb-4" // Espaçamento abaixo da imagem
        />
        ...
        <Button variant="outline" className="w-full py-2 my-6 text-lg">
          Login
        </Button>
      </form>
    </div>
