...
export default function SideChats() {
   ...
   return (
    <div className="h-[90vh] w-full md:max-w-[27vw] md:border-r-2 md:pr-6">
    ...
    <Input
        className="pl-14 mr-12 py-6 max-w-[90vw] md:max-w-full" // Limita a largura no mobile e ajusta no desktop
    ...
    {searchTerm && (
        ...
        <ScrollArea className="max-h-[80vh] w-full mt-6">
